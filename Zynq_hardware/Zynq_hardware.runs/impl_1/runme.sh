...
HD_PWD='C:/fake_d/ZedboardPractice/PetalinuxTest/Zynq_hardware/Zynq_hardware.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log HardwareConfig1_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source HardwareConfig1_wrapper.tcl -notrace
