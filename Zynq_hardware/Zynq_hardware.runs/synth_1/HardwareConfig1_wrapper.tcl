...
namespace eval ::optrace {
  variable script "C:/fake_d/ZedboardPractice/PetalinuxTest/Zynq_hardware/Zynq_hardware.runs/synth_1/HardwareConfig1_wrapper.tcl"
...
synth_design -top HardwareConfig1_wrapper -part xc7z020clg484-1
...
write_checkpoint -force -noxdef HardwareConfig1_wrapper.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
create_report "synth_1_synth_report_utilization_0" "report_utilization -file HardwareConfig1_wrapper_utilization_synth.rpt -pb HardwareConfig1_wrapper_utilization_synth.pb"
