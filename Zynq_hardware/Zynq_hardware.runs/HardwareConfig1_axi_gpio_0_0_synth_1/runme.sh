...
HD_PWD='C:/fake_d/ZedboardPractice/PetalinuxTest/Zynq_hardware/Zynq_hardware.runs/HardwareConfig1_axi_gpio_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log HardwareConfig1_axi_gpio_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source HardwareConfig1_axi_gpio_0_0.tcl
