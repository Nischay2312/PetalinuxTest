...
HD_PWD='C:/fake_d/ZedboardPractice/Lab_4/PetaLinux_zynq700/PetaLinux_zynq700.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mainProcessingUnit_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mainProcessingUnit_wrapper.tcl -notrace
