...
HD_PWD='C:/fake_d/ZedboardPractice/Lab_4/PetaLinux_zynq700/PetaLinux_zynq700.runs/mainProcessingUnit_axi_gpio_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mainProcessingUnit_axi_gpio_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mainProcessingUnit_axi_gpio_0_0.tcl
