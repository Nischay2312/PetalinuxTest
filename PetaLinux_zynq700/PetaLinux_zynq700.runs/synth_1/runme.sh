...
HD_PWD='C:/fake_d/ZedboardPractice/Lab_4/PetaLinux_zynq700/PetaLinux_zynq700.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mainProcessingUnit_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mainProcessingUnit_wrapper.tcl
