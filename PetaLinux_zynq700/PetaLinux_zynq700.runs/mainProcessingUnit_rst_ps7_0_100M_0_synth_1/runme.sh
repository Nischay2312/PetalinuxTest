...
HD_PWD='C:/fake_d/ZedboardPractice/Lab_4/PetaLinux_zynq700/PetaLinux_zynq700.runs/mainProcessingUnit_rst_ps7_0_100M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mainProcessingUnit_rst_ps7_0_100M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mainProcessingUnit_rst_ps7_0_100M_0.tcl
